...
def stem(word):
    ...
    # pp(d)
    # end = time.time()
    # print("Робота виконана за {} sec".format(end-st))
    # print("Кількість слів у тексті: {}".format(len(words)))
    # print("Кількість унікальних слів: {}".format(len(list(set(words)))))
    # print('Кількість унікальних слів після стемінгу: {}'.format(len(list(set(st_words)))))
